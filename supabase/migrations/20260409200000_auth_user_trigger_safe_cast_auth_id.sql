-- Hindari gagal signup karena metadata tidak valid (cast integer/date) → "Database error creating new user".
-- Pakai id auth yang sama di public.users agar konsisten dengan JWT sub / integrasi ke depan.
