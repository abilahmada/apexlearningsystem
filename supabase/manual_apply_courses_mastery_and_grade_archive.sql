-- Manual apply (Supabase SQL Editor) jika remote belum menjalankan migration lokal.
-- Isi: kolom courses.mastery_threshold + tabel student_progress_grade_archives + trigger.
-- Setelah sukses: reload schema di Supabase (atau tunggu cache) lalu refresh panel admin.
